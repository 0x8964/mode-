...
-- Dumping database structure for samp2020vn
CREATE DATABASE IF NOT EXISTS `samp2020vn` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `samp2020vn`;

-- Dumping structure for table samp2020vn.items
...
-- Dumping data for table samp2020vn.items: ~43 rows (approximately)
